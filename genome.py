...
class Genome():
    ...
    def update_hash(self):
        ...
        """
        genh = str(self.geneparam['filter']) + str(self.geneparam['filter1']) \
               + str(self.geneparam['filter2']) + self.geneparam['activation'] \
               + str(self.geneparam['linear_dim']) + self.geneparam['optimizer'] \
                + str(self.geneparam['lr']) + str(self.geneparam['batch_size'])
